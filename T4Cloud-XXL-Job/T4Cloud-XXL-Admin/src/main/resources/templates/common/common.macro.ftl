...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>T4</b></span>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "help">active</#if>" ><a href="https://www.xuxueli.com/xxl-job/#%E3%80%8A%E5%88%86%E5%B8%83%E5%BC%8F%E4%BB%BB%E5%8A%A1%E8%B0%83%E5%BA%A6%E5%B9%B3%E5%8F%B0XXL-JOB%E3%80%8B" target="_blank" ><i class="fa fa-circle-o text-gray"></i><span>${I18n.job_help_document}</span></a></li>
...
<#macro commonFooter >
	<footer class="main-footer">
		源自开源项目XXL-JOB，Powered by  <a href="https://github.com/xuxueli/xxl-job" target="_blank" ><b>XXL</b></a>
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2019-${.now?string('yyyy')} &nbsp;
                <a href="https://t4cloud.com/" target="_blank" >T4Cloud</a>
