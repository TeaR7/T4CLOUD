...
public class SysDictController extends T4Controller<SysDict, ISysDictService> {
    ...
    public R<SysDict> detail(SysDict sysDict, HttpServletRequest req) {
        QueryWrapper<SysDict> sysDictQueryWrapper = T4Query.initQuery(sysDict, req.getParameterMap());
        SysDict detail = service.getOne(sysDictQueryWrapper);
    ...
    public R<List<SysDict>> list(SysDict sysDict, HttpServletRequest req) {
        QueryWrapper<SysDict> sysDictQueryWrapper = T4Query.initQuery(sysDict, req.getParameterMap());
        List<SysDict> list = service.list(sysDictQueryWrapper);
    ...
    public R<IPage<SysDict>> page(SysDict sysDict,
        ...
        QueryWrapper<SysDict> sysDictQueryWrapper = T4Query.initQuery(sysDict, req.getParameterMap());
        IPage<SysDict> pages = service.page(new Page<>(pageNo, pageSize), sysDictQueryWrapper);
