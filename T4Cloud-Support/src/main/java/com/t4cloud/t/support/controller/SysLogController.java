...
public class SysLogController extends T4Controller<SysLog, ISysLogService> {
    ...
    public R<SysLog> detail(SysLog sysLog, HttpServletRequest req) {
        QueryWrapper<SysLog> sysLogQueryWapper = T4Query.initQuery(sysLog, req.getParameterMap());
        SysLog detail = service.getOne(sysLogQueryWapper);
    ...
    public R<List<SysLog>> list(SysLog sysLog, HttpServletRequest req) {
        QueryWrapper<SysLog> sysLogQueryWapper = T4Query.initQuery(sysLog, req.getParameterMap());
        List<SysLog> list = service.list(sysLogQueryWapper);
    ...
    public R<IPage<SysLog>> page(SysLog sysLog,
        ...
        QueryWrapper<SysLog> sysLogQueryWapper = T4Query.initQuery(sysLog, req.getParameterMap());
        IPage<SysLog> pages = service.page(new Page<>(pageNo, pageSize), sysLogQueryWapper);
