...
public class SupResourceController extends T4Controller<SupResource, ISupResourceService> {
    ...
    public R<SupResource> detail(SupResource supResource, HttpServletRequest req) {
        QueryWrapper<SupResource> supResourceQueryWapper = T4Query.initQuery(supResource, req.getParameterMap());
        SupResource detail = service.getOne(supResourceQueryWapper);
    ...
    public R<List<SupResource>> list(SupResource supResource, HttpServletRequest req) {
        QueryWrapper<SupResource> supResourceQueryWapper = T4Query.initQuery(supResource, req.getParameterMap());
        List<SupResource> list = service.list(supResourceQueryWapper);
    ...
    public R<IPage<SupResource>> page(SupResource supResource,
        ...
        QueryWrapper<SupResource> supResourceQueryWapper = T4Query.initQuery(supResource, req.getParameterMap());
        IPage<SupResource> pages = service.page(new Page<>(pageNo, pageSize), supResourceQueryWapper);
