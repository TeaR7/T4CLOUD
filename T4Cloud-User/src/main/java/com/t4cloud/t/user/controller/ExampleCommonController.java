...
public class ExampleCommonController extends T4Controller<ExampleCommon, IExampleCommonService> {
    ...
    public R<ExampleCommon> detail(ExampleCommon exampleCommon, HttpServletRequest req) {
        QueryWrapper<ExampleCommon> exampleCommonQueryWapper = T4Query.initQuery(exampleCommon, req.getParameterMap());
        ExampleCommon detail = service.getOne(exampleCommonQueryWapper);
    ...
    public R<List<ExampleCommon>> list(ExampleCommon exampleCommon, HttpServletRequest req) {
        QueryWrapper<ExampleCommon> exampleCommonQueryWapper = T4Query.initQuery(exampleCommon, req.getParameterMap());
        List<ExampleCommon> list = service.list(exampleCommonQueryWapper);
    ...
    public R<IPage<ExampleCommon>> page(ExampleCommon exampleCommon,
        ...
        QueryWrapper<ExampleCommon> exampleCommonQueryWapper = T4Query.initQuery(exampleCommon, req.getParameterMap());
        IPage<ExampleCommon> pages = service.page(new Page<>(pageNo, pageSize), exampleCommonQueryWapper);
